...
<html>
    ...
    <body>
        ...
        <p><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><strong>Models
            ...
            <a href="/OrderStatus.jsp" mce_href="OrderStatus.jsp">View Cart</a>
        <p/>
    <table width="75%" border="1">
        <tr>
            <td><form name="modelDetail1" method="POST" action="servlet/OrderStatusServlet">
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Model:</strong>
                TF-Model1</font><input type="hidden" name="id" value="TF-MODEL1">
                ...
                <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Price:</strong>
                    $10.00</font><input type="hidden" name="price" value="10"></p><input type="hidden" name="action" value="add"><input type="submit" name="addStatus" value="Add To Cart">
            </form></td>
            <td><form name="modelDetail2" method="POST" action="servlet/OrderStatusServlet"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Model</strong>:
                ...
                <p><font size="2"><strong>Price</strong>: $20.00<input type="hidden" name="price" value="20"></font></p>
                    ...
                    <input type="submit" name="addStatus" value="Add To Cart">
            </font></form></td>
            </tr>
            <tr>
            <td><form name="modelDetail3" method="POST" action="servlet/OrderStatusServlet"><p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Model:</strong>
                TF-Model3</font><input type="hidden" name="id" value="TF-MODEL3"></p>
                <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Description:</strong>
            ...
            <td><form name="modelDetail4" method="POST" action="servlet/OrderStatusServlet"><p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Model</strong>:
                TF-Model4</font><input type="hidden" name="id" value="TF-MODEL4"></p>
                <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Description</strong>:
                ...
                <input type="hidden" name="action" value="add"><input type="submit" name="addStatus" value="Add To Cart"></form></td>
            </tr>
    </table>
<p> </p>
</body>
